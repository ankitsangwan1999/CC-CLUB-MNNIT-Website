...
// $check_cont = $content
//admin_name,Title,Label,content,Schedule,created)
// ,'$title','$label','$content','$schedule'
// '$admin_name','$title','$label', '$schedule'
// echo $content;
// ------------------------------------------------------------------'$category'
$sql= "INSERT INTO posts(admin_name,Title,Label,Schedule)
 VALUES('$admin_name','$title','$label','$schedule')";
