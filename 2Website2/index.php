...
<?php include_once"users/incl/side_navu.php";?>
    ...
    <div class="container">
     ...
     <!-- 
        ...
        $count=count($result);
           for($i=0;$i<$count;$i++){
                 $sql1="SELECT * FROM posts WHERE s_no=$i+1";
 ...
 -->
        <ul class="collection with-header">
            ...
            <li class="collection-item">
                <?php
        //         $sql="SELECT * FROM posts WHERE s_no=6";
        // $result = mysqli_query($conn, $sql);
        // $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
        // echo"Hello";
...
<!-- 
      ...
      <div class="parallax"><img src="<?php// echo $image_path."/".$image_name?>"></div>
    </div> -->
...
<!-- <div id="index-banner" class="parallax-container">
        ...
        <div class="parallax bg_img2"><img src="<?php //echo $image_path."/".$image_name?>" alt="Unsplashed background img 1" height="1500px"></div>
    </div> -->
                ...
                <ul class="collapsible popout">
                    <li class="teal">
                        ...
                        <div class="collapsible-body">
                            ...
                            <div>
                                <div class="row">
                                    <form method="POST" action="users/include/comment_inc.php" class="col s12">
                                      <div class="row">
